...
echo "export PROJECT_HOME=~/Devel" >> $EXTRA_PATH
echo "export VIRTUALENVWRAPPER_VIRTUALENV=/usr/local/bin/virtualenv" >> $EXTRA_PATH 
...
mkvirtualenv --python=/usr/local/bin/python py2-data
workon py2-data
